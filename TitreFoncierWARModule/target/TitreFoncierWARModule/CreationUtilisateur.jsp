...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Page De creation Utilisateur et Compte
      ...
      <!--------------------------
        ...
        <div class="row">
            ...
            <div class="box-header with-border">
              <h3 class="box-title">Creation Utilisateur</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              ...
              <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="Nom utilisateur">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputNom" class="col-sm-2 control-label">PostNom</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="PostNom utilisateur">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="PreNom utilisateur">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputNom" class="col-sm-2 control-label">Telephone</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="Telephone utilisateur">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="email" class="form-control" id="inputEmail3" placeholder="Email utilisateur">
                  </div>
                </div>
                <div class="form-group">
        	...
        	<div class="col-md-6">
        		<div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Creation Compte utilisateur</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal">
              <div class="box-body">
              <div class="form-group">
                  <label for="inputNom" class="col-sm-2 control-label">Login</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="Login utilisateur">
                  </div>
                </div>
                <div class="form-group">
                  <label for="inputNom" class="col-sm-2 control-label">Mot de pass</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="inputNom" placeholder="mot de passe">
                  </div>
                </div>
                ...
                <select class="form-control select2">
                  <option selected="selected">Beston</option>
                  <option>Erick</option>
                  <option>Banza</option>
                  <option>Serge</option>
                  <option>Depi</option>
